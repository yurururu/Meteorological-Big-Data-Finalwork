    ...
    def __init__(self, number_channels=64, number_residual_blocks=4, upsampling_factor=2, noise=False, constraints='none', dim=1):
        ...
        if noise:
            if upsampling_factor == 4:
                ...
                self.conv_trans0 = nn.ConvTranspose2d(100, 1, kernel_size=(16, 16), padding=0, stride=1)
            else:
                self.conv_trans0 = nn.ConvTranspose2d(100, 1, kernel_size=(64, 64), padding=0, stride=1)
